...
namespace Orders.Controllers
{
    public class SuppliersController : Controller
    {
        ...
        public SuppliersController(OrdersApplicationDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Supplier != null ? 
                          ...
                          Problem("Entity set 'OrdersApplicationDbContext.Supplier'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'OrdersApplicationDbContext.Supplier'  is null.");
            }
            var supplier = await _context.Supplier.FindAsync(id);
            if (supplier != null)
            {
